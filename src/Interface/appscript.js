function updateLeaveData(jsonInput, option) {
  ...
  async function calculateAllMonths() {
      var spreadsheetId = "1z5NJ_fepnPul1QNWYRJpQ9cU_Btgz968QRg_OkXqkkw";
  ...
  async function bizSalesCalculateAllMonths() {
  ...
  async function doGet(e) {
    techResponse = await calculateAllMonths()
    bizSalesResponse = await bizSalesCalculateAllMonths()
    const responseData = {
